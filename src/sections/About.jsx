        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-2 text-lg sm:text-xl text-white/90 font-semibold">
              Software Engineer (Machine Learning & Cloud)
            </p>

            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I translate complex data and technology into scalable,
              business-focused solutions within consulting and corporate
              environments. My hands-on experience includes Python programming,
              SQL, data analysis, and machine learning fundamentals, enabling
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                ...
                { label: "Speciality", value: "Machine Learning & Cloud" },
                { label: "Mindset", value: "Quality over Quantity" },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              A results-oriented technology professional with experience in data
              analysis, Python, SQL, and machine learning fundamentals. Skilled
              in applying analytical and technical expertise to support business
              intelligence, operational efficiency, and strategic
              decision-making in enterprise and consulting environments.
            </p>
